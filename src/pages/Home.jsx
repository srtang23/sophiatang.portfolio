...
function Home() {
  useEffect(() => {
    // Reset body className when returning to home
    ...
    <>
      ...
      <section className="projects-section" id="work">
        ...
        <ProjectCard
          project="sprout"
          title="Sprout"
          description="A self-care mobile app with a physical plant companion that tracks daily wellness goals and visualizes progress."
